#for help see:
#https://brunaw.com/phd/jags/presentation.pdf
#https://www.andrewheiss.com/blog/2021/11/08/beta-regression-guide/#b-beta-regression-bayesian-style
...
model{ 
  ...
  for(i in 1:n){ 
    ...
    logit(mu[i]) <- bCity[City[i]] + b[1]*prcnt_park_area[i] + b[2]*mean_park_EIratio[i] + 
